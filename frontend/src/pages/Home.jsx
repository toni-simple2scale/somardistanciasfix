                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="tel:+351961313663" className="hover:text-orange-600 transition-colors whitespace-nowrap">
                          +351 961 313 663
                        </a>
                      </p>
                      <p className="text-gray-600">
                        <a href="tel:+351960120888" className="hover:text-orange-600 transition-colors whitespace-nowrap">
                          +351 960 120 888
                        </a>
                      </p>
                    </div>
